...
const MyChats = ({ fetchAgain }) => {
  ...
  const chatBg = useColorModeValue("#F8F8F8", "#4A5568");
  const selectedChatBg = useColorModeValue("#38B2AC", "#319795");
  const textColor = useColorModeValue("black", "white");
  const unselectedChatBg = useColorModeValue("#E8E8E8", "#2D3748");
